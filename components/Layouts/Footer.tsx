    ...
    return <div>
        <footer>
            ...
            <div className="flex lg:flex-row flex-col justify-between">
                ...
                <div className="leading-10 uppercase text-customLightBlue-1 text-sm">About Us</div>
            ...
            <div className="w-full overflow-hidden md:my-px md:px-px md:w-1/2 lg:pr-2 lg:w-5/12 pb-6">
              <div className="leading-10 uppercase text-customLightBlue-1 text-sm">Useful Links</div>
              <ul className="nav navbar-nav flex flex-col space-y-2 text-customGray-3 ">
                <li className="text-sm">
                  <a
            ...
            <div className="w-full overflow-hidden md:my-px md:px-px md:w-1/2 lg:pr-2 lg:w-1/5 pb-6">
              <div className="leading-10 uppercase text-customLightBlue-1 text-sm">Get in Touch</div>
              <ul className="nav navbar-nav flex flex-col space-y-2 text-customGray-3 ">
                <li className="text-sm">
        ...
        <div className="w-full flex items-center justify-center border-t border-customGray-3 bg-customPink-2">
            <p className="text-center text-customGray-3 text-xs mr-5 my-5 leading-6">
              Copyright {dayjs().format('YYYY')} SAND & POPULAR All Rights Reserved
              <br/> Designed by <span className='font-bold' >backline Solutions</span>
            </p>
          </div>
      </footer>
  </div>;
