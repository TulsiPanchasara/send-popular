...
const Quality = () => {
    return (
        ...
        <div className='lg:ml-20' >
            <div className='uppercase text-customLightBlue-1 text-sm ' >Quality</div>
            <div className='max-w-lg text-customGray-3 mt-10' >
      ...
      <div className='lg:flex justify-center mt-40' >
        <div className='lg:hidden block' >   <ImageContainer /></div>
        <div className='lg:mr-20' >
            <div className='uppercase text-customLightBlue-1 text-sm ' >About Us</div>
            <div className='max-w-lg text-customGray-3 mt-10' >
